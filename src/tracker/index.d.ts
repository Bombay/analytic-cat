export type TrackedProperties = {
   ...
   *
   * @description extracted from `window.navigator.language`
   * @example 'https://analytics.ancat.is/docs/getting-started'
   */
  referrer: string
...
export type AncatTracker = {
  track: {
     ...
     *
     * @example ```
     * ancat.track('signup-button', { name: 'newsletter', id: 123 });
     * ```
     */
     ...
     *
     * @example ```
     * ancat.track({ website: 'e676c9b4-11e4-4ef1-a4d7-87001773e9f2', url: '/home', title: 'Home page' });
     * ```
     */
     ...
     *
     * @example ```
     * ancat.track((props) => ({ ...props, url: path }));
     * ```
     */
